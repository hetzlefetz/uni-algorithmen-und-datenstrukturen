...
// AnalyzeWords2 aw = new AnalyzeWords2("file:blatest.txt");
// assertEquals("\"ab\" should be first when sorted!", 0,
// aw.isStoredAtPosition("ab"));
// assertEquals("\"blablabla\" should be last when sorted!", 9,
// aw.isStoredAtPosition("blablabla"));
// }

// @Test
// public void testWordAtPosition() throws IOException {
// AnalyzeWords2 aw = new AnalyzeWords2("file:blatest.txt");
// assertEquals("\"ab\" should be first when sorted!", "ab",
// aw.wordAtPosition(0));
// assertEquals("\"blablabla\" should be last when sorted!", "blablabla",
// aw.wordAtPosition(9));
// assertEquals("\"bla\" should be in middlefor (ListNode ln1 = tn.positions;
// ln1 != null; ln1 = ln1.next) { when sorted!", "bla", aw.wordAtPosition(5));
// }
