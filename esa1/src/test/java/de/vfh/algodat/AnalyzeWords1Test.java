...
public class AnalyzeWords1Test {
	...
	public void testFrequency() throws IOException {
		AnalyzeWords1 aw = new AnalyzeWords1("file:TestMaterial/blatest.txt");
	...
	public void testMostFrequent2() throws IOException {
		AnalyzeWords1 aw = new AnalyzeWords1("file:TestMaterial/blatest2.txt");
	...
	public void testNotUsingCount() throws IOException {
		AnalyzeWords1 aw = new AnalyzeWords1("file:TestMaterial/TestMaterial/blatest2.txt");
